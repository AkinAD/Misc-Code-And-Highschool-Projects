...
namespace Adewale.SafeCracker
{
    public partial class frmSafeCracker : Form
    {
        ...
        private void ToolTip()
        {
            ...
            toolTip1.SetToolTip(this.btnHint, "");
...
// i learnt the abve code from a video online, a way of removing a code from final compile without having to delete the line
            ...
            else
            {
                ...
                txtResults.AppendText("Time: " + Timer.ToString() + "\r\n");
        ...
        private void btnHint_Click(object sender, EventArgs e)
        {
            ...
            txtResults.AppendText("If you multiply the secret code by 4 add 98 divide by 3, add 69 (cuz why not) multiply by 1.876 subtract 7 and round to the nearest whole number,you'll get : " + Answer + "\r\nI'd personally just guess, but to each their own");
            HintUsed = true;
         }
